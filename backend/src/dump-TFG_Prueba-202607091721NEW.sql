...
\restrict fMelyVbVEYMzE5PplOd5bEz8Pknbji9bEORH8vlHk5VyGLqljB1np0XOdGH78oe

-- Dumped from database version 18.1
-- Dumped by pg_dump version 18.1

-- Started on 2026-07-09 17:21:39
...
--
-- TOC entry 266 (class 1255 OID 41753)
...
--
-- TOC entry 263 (class 1255 OID 41752)
...
--
-- TOC entry 264 (class 1255 OID 41758)
...
--
-- TOC entry 265 (class 1255 OID 41760)
...
--
-- TOC entry 262 (class 1255 OID 41755)
...
--
-- TOC entry 249 (class 1259 OID 57674)
-- Name: dm_golesesperados_partidos; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.dm_golesesperados_partidos OWNER TO postgres;

--
-- TOC entry 241 (class 1259 OID 41795)
-- Name: dm_jugadores_ratings; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.dm_jugadores_ratings (
    id_jugador integer CONSTRAINT h_jugadores_ratings_id_jugador_not_null NOT NULL,
    temporada integer CONSTRAINT h_jugadores_ratings_temporada_not_null NOT NULL,
    nombre text,
...
ALTER TABLE public.dm_jugadores_ratings OWNER TO postgres;
...
--
-- TOC entry 250 (class 1259 OID 57697)
-- Name: dm_recomendacion_fichajes; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.dm_recomendacion_fichajes OWNER TO postgres;
...
--
-- TOC entry 4951 (class 2604 OID 41628)
...
--
-- TOC entry 4976 (class 2604 OID 41629)
...
--
-- TOC entry 4978 (class 2604 OID 41630)
...
--
-- TOC entry 4982 (class 2606 OID 41632)
...
--
-- TOC entry 4984 (class 2606 OID 41634)
...
--
-- TOC entry 4986 (class 2606 OID 41636)
...
--
-- TOC entry 4990 (class 2606 OID 41638)
...
--
-- TOC entry 4992 (class 2606 OID 41640)
...
--
-- TOC entry 4994 (class 2606 OID 41642)
...
--
-- TOC entry 4996 (class 2606 OID 41644)
...
--
-- TOC entry 5027 (class 2606 OID 49527)
...
--
-- TOC entry 5025 (class 2606 OID 49521)
...
--
-- TOC entry 5031 (class 2606 OID 57681)
-- Name: dm_golesesperados_partidos dm_golesesperados_partidos_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.dm_golesesperados_partidos
    ADD CONSTRAINT dm_golesesperados_partidos_pkey PRIMARY KEY (id_partido);


--
-- TOC entry 5023 (class 2606 OID 49551)
...
--
-- TOC entry 5021 (class 2606 OID 49507)
...
--
-- TOC entry 5019 (class 2606 OID 57627)
...
--
-- TOC entry 5033 (class 2606 OID 57706)
-- Name: dm_recomendacion_fichajes dm_recomendacion_fichajes_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.dm_recomendacion_fichajes
    ADD CONSTRAINT dm_recomendacion_fichajes_pkey PRIMARY KEY (id_equipo, necesidad, id_jugador);


--
-- TOC entry 5029 (class 2606 OID 49536)
...
--
-- TOC entry 5017 (class 2606 OID 49493)
...
--
-- TOC entry 4999 (class 2606 OID 41646)
...
--
-- TOC entry 5001 (class 2606 OID 41648)
...
--
-- TOC entry 5003 (class 2606 OID 41650)
...
--
-- TOC entry 5005 (class 2606 OID 41652)
...
--
-- TOC entry 5015 (class 2606 OID 41803)
-- Name: dm_jugadores_ratings h_jugadores_ratings_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.dm_jugadores_ratings
    ADD CONSTRAINT h_jugadores_ratings_pkey PRIMARY KEY (id_jugador, temporada);


--
-- TOC entry 5007 (class 2606 OID 41654)
...
--
-- TOC entry 5010 (class 2606 OID 41656)
...
--
-- TOC entry 5008 (class 1259 OID 41657)
...
--
-- TOC entry 5011 (class 1259 OID 41658)
...
--
-- TOC entry 5012 (class 1259 OID 41659)
...
--
-- TOC entry 5013 (class 1259 OID 41660)
...
--
-- TOC entry 4987 (class 1259 OID 41661)
...
--
-- TOC entry 4988 (class 1259 OID 41662)
...
--
-- TOC entry 4997 (class 1259 OID 41663)
...
--
-- TOC entry 5060 (class 2620 OID 41757)
...
--
-- TOC entry 5058 (class 2620 OID 41754)
...
--
-- TOC entry 5057 (class 2620 OID 41761)
...
--
-- TOC entry 5059 (class 2620 OID 41756)
...
--
-- TOC entry 5034 (class 2606 OID 41664)
...
--
-- TOC entry 5035 (class 2606 OID 41669)
...
--
-- TOC entry 5036 (class 2606 OID 41674)
...
--
-- TOC entry 5051 (class 2606 OID 57687)
-- Name: dm_golesesperados_partidos fk_dm_golesesperados_local; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.dm_golesesperados_partidos
    ADD CONSTRAINT fk_dm_golesesperados_local FOREIGN KEY (id_local) REFERENCES public.dim_equipo(id_equipo);


--
-- TOC entry 5052 (class 2606 OID 57682)
-- Name: dm_golesesperados_partidos fk_dm_golesesperados_partido; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.dm_golesesperados_partidos
    ADD CONSTRAINT fk_dm_golesesperados_partido FOREIGN KEY (id_partido) REFERENCES public.dim_partidos(id_partido);


--
-- TOC entry 5053 (class 2606 OID 57692)
-- Name: dm_golesesperados_partidos fk_dm_golesesperados_visitante; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.dm_golesesperados_partidos
    ADD CONSTRAINT fk_dm_golesesperados_visitante FOREIGN KEY (id_visitante) REFERENCES public.dim_equipo(id_equipo);


--
-- TOC entry 5054 (class 2606 OID 57707)
-- Name: dm_recomendacion_fichajes fk_dm_recomendacion_equipo; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.dm_recomendacion_fichajes
    ADD CONSTRAINT fk_dm_recomendacion_equipo FOREIGN KEY (id_equipo) REFERENCES public.dim_equipo(id_equipo);


--
-- TOC entry 5055 (class 2606 OID 57717)
-- Name: dm_recomendacion_fichajes fk_dm_recomendacion_equipo_actual; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.dm_recomendacion_fichajes
    ADD CONSTRAINT fk_dm_recomendacion_equipo_actual FOREIGN KEY (id_equipo_actual) REFERENCES public.dim_equipo(id_equipo);


--
-- TOC entry 5056 (class 2606 OID 57712)
-- Name: dm_recomendacion_fichajes fk_dm_recomendacion_jugador; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.dm_recomendacion_fichajes
    ADD CONSTRAINT fk_dm_recomendacion_jugador FOREIGN KEY (id_jugador) REFERENCES public.dim_jugador(id_jugador);


--
-- TOC entry 5037 (class 2606 OID 41679)
...
--
-- TOC entry 5038 (class 2606 OID 41684)
...
--
-- TOC entry 5039 (class 2606 OID 41689)
...
--
-- TOC entry 5040 (class 2606 OID 41694)
...
--
-- TOC entry 5041 (class 2606 OID 41699)
...
--
-- TOC entry 5042 (class 2606 OID 41704)
...
--
-- TOC entry 5043 (class 2606 OID 41709)
...
--
-- TOC entry 5044 (class 2606 OID 41714)
...
--
-- TOC entry 5045 (class 2606 OID 41719)
...
--
-- TOC entry 5046 (class 2606 OID 41724)
...
--
-- TOC entry 5047 (class 2606 OID 41729)
...
--
-- TOC entry 5048 (class 2606 OID 41734)
...
--
-- TOC entry 5049 (class 2606 OID 41739)
...
--
-- TOC entry 5050 (class 2606 OID 41744)
...
-- Completed on 2026-07-09 17:21:40

--
-- PostgreSQL database dump complete
--

\unrestrict fMelyVbVEYMzE5PplOd5bEz8Pknbji9bEORH8vlHk5VyGLqljB1np0XOdGH78oe
